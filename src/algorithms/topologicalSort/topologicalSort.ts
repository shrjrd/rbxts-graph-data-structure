...
export type TopologicalSortOptions<Node, LinkProps> = {
	 ...
	 * @returns boolean
	 */
	shouldFollow?: (args: { source: Node; target: Node; props: LinkProps; graph: Graph<Node, LinkProps> }) => boolean;
};

export function topologicalSort<Node extends defined, LinkProps>(
	graph: Graph<Node, LinkProps>,
	opts: TopologicalSortOptions<NoInfer<Node>, NoInfer<LinkProps>> = {},
) {
	return JsArray.reverse(
